...
HERB_JSON_PATH = get_file_path("__002__extract_information/中药数据抽取结果.json")
HERB_TXT_DIR = get_file_path("__001__crawler/中药2")
OUTPUT_PATH = get_file_path("__002__extract_information/中药Alpaca数据.json")
