...
load_dotenv()
# load_dotenv(r"D:\workspace\workspace-python\k_graph_1\.env")
...
class Config:
    def __init__(self):
        ...
        # 读取图谱模式层的数据
        # self.TCM_METADATA = open(get_file_path("__003__create_neo4j_database/tcm_metadata.json"), "r",encoding='utf-8').read()
